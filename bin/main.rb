    ...
    bot.listen do |message|
      case message.text
        ...
        when '/movie'
            ...
            bot.api.send_message(chat_id: message.chat.id, text: ("The name of the movie is#{filmz[:imageUrl]} #{filmz[:title]} and has a rank of #{filmz[:rank]}").to_s, date: message.date)
        when '/stop'
